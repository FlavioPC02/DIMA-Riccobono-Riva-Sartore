...
void main() {
  ...
  group('initializeNotificationService', () {
    test(
      'initializes the plugin and creates Android channel successfully',
      () async {
        when(
          () => mockPlugin
        ...
        expect(captured.iOS?.requestAlertPermission, isFalse);
        expect(captured.iOS?.requestBadgePermission, isFalse);
        expect(captured.iOS?.requestSoundPermission, isFalse);
      },
    );
  ...
  group('showNotification', () {
    ...
    test(
      'aborts and does not show notification if permissions are missing',
      () async {
    ...
    test(
      'catches and handles exceptions during notification display',
      () async {
        NotificationService.mockPermissionCheck = () async => true;
